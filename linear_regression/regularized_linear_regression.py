...
data = pd.read_csv(
    '/Users/daniel/Data-Science/Data/from_R_datasets/swiss/swiss.csv')

X = data.drop(["Fertility"], axis=1)
y = data["Fertility"]

train_idx = [31, 15, 14, 3, 42, 37, 45, 25, 26, 27,
             5, 38, 28, 9, 29, 44, 8, 39, 7, 10, 34, 19, 4]
...
# need to use some GridSearch to find out the best alpha
ridge_reg_model_1 = OLS_model.fit_regularized(L1_wt=0.0, alpha=0.008)
print('\nstatsmodels')
