...
--- | --- | ---
<a href="https://github.com/daniel-yj-yang/distribution">Gaussian</a> Naive Bayes | P(x<sub>i</sub>\|y) is normally distributed |
<a href="https://github.com/daniel-yj-yang/distribution">Multinomial</a> Naive Bayes | P(x<sub>i</sub>\|y) is generated by a <a href="https://github.com/daniel-yj-yang/distribution">multinomial distribution</a> | - Used for document classification<br/>- X are independent term frequency in the document
<a href="https://github.com/daniel-yj-yang/distribution">Bernoulli</a> Naive Bayes | P(x<sub>i</sub>\|y) is generated by a multivariate <a href="https://github.com/daniel-yj-yang/distribution">Bernoulli distribution</a> | - Used for document classification<br/>- X are independent binary variables (whether a word occurs in a document or not)
