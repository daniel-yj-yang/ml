...
Recall<br>=True Positive Rate | horizontal | TP/P | Type II error, Miss | High cost associated with missing gold when digging for gold | The y-axis in the ROC curve, **Sensitivity**, <a href="https://en.wikipedia.org/wiki/Statistical_power">Power</a>, Hit Rate, (1-β)
...
F<sub>1</sub> score = the harmonic mean of precision and recall = a measure of accuracy 
