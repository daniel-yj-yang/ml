...
<img src="./images/Lena_reconstructed_up_to_30_PCs.gif" width="256px"><br/>
  ...
  <tr>
    <td><p align="center">
      ...
      Memory: 697x1127x3 (<b>X</b>) = 2,356,557<br/>
    ...
    <td><p align="center">Reconstructed using up to 30 out of 697 PCs<br/>
      Memory: 697x30x3 (<b>T<sub>L</sub></b>) + 30x1127x3 (<b>W<sub>L</sub></b>) + 1x1127x3 (<b>X<sub>colMeans</sub></b>) = 167,541<br/>(~ 93% reduction)<br/>
