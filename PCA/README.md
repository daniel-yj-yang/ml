...
- <a href="### Approach 1: Eigendecomposition of the data covariance matrix">Approach 1: Eigendecomposition of the data covariance matrix</a>
...
<b>V</b> | A p x p real-valued orthonormal matrix, where <b>V' = V<sup>-1</sup></b> and <b>V'V = I</b>. Importantly, <b>V</b> is equivalent to <b>W</b> 
