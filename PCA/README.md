...
- If v<sub>k</sub> is chosen to have unit length (i.e., v<sub>k</sub>'v<sub>k</sub> = 1) then **Var(PC<sub>k</sub>=z<sub>k</sub>) = λ<sub>k</sub>**.
