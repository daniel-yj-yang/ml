...
<a href="./model_evaluation">Algorithm performance/<br/>Model evaluation</a> | * For classification, predictive power can be assessed via <a href="./model-evaluation/">the area under ROC</a><br/>* For regression, there are a variety of choices, including <a href="./model-evaluation/">R<sup>2</sup>, AIC, RMSE</a>
