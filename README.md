# Machine Learning
<b>Learning the (hidden or obvious) <a href="./regularity_of_the_world.md">regularity of the world</a> via computer algorithms that <a href="./model_optimization">optimize parameters through training</a></b>.
