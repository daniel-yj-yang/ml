# Machine Learning
<b>Learning the (hidden) regularity of the world via computer algorithms that <a href="https://github.com/daniel-yj-yang/model_optimization">optimize parameters through training</a></b>.
