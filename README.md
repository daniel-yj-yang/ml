...
In supervised ML, the learned model can be used to <b>reduce uncertainty</b> when guessing/predicting the target label associated with data signals, namely, identifying data signals relevant for the new, unseen.
